...
install -m 644 "$HOME/sources/rpm/SOURCES/%{name}.service" %{buildroot}%{_unitdir}/
install -m 644 "$HOME/sources/rpm/SOURCES/%{name}" %{buildroot}%{_sysconfdir}/sysconfig/%{name}
